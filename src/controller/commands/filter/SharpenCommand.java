...
/**
 * a class that acts as the command for sharpenning a picture.
 */
public class SharpenCommand implements ICommand {
  ...
  public void run(Scanner scanner, IImageDataBase model) {
    ...
    ITransformation sharpenedTransformation = new SharpenedTransformation();
    IImageState sharpenedImage = sharpenedTransformation.run(sourceImage);
